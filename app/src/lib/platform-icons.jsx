...
export function UrlIcon({ className = 'w-5 h-5' }) {
  return (
...
export function DriveIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M7.71 3.5L1.15 15l3.43 5.95L11.13 9.5 7.71 3.5zm4.87 0L22.85 15l-3.43 5.95L8.13 9.5h11.74l-3.43-5.95H12.58z"/>
    </svg>
  );
}

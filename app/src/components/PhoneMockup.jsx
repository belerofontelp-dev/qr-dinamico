export default function PhoneMockup({ children }) {
  return (
    <div className="relative mx-auto" style={{ width: 260, height: 520 }}>
      <div
        className="absolute z-10 bg-white rounded-[24px]"
        style={{ left: 16, top: 48, right: 16, bottom: 48, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
      >
        {children}
      </div>
      <svg viewBox="0 0 260 520" className="absolute inset-0 w-full h-full pointer-events-none z-20">
